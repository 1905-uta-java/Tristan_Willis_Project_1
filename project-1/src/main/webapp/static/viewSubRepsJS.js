...
let other = sessionStorage.getItem("sub_id");
if(!token){
	...
	if(tokenArr.length==2){
		if(!other){
			window.location.href="http://localhost:8080/project-1/static/viewSubordinates.html";
		}
		else{
			let baseUrl = "http://localhost:8080/project-1/api/pendreps?id="+tokenArr[0]+"&emp_id="+other;
			getInfo(baseUrl, displayInfo);
		}
	}
	else{
	    window.location.href = "http://localhost:8080/project-1/static/index.html";
